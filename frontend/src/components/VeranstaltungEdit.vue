<template>
    ...
    <h1 v-else>Veranstaltungsbearbeitung</h1>
     ...
     <td><input type="text" id="label" placeholder="Veranstaltungsname" v-model="project.name"></td>
     </tr><tr>
     <td><label>Beginndatum: </label></td>
     <td><input type="text" id="date" placeholder="Datum (TT.MM.JJJ)" v-model="project.datum"></td>
     </tr><tr>
     <td><label>Enddatum: </label></td>
     <td><input type="text" id="date" placeholder="Datum (TT.MM.JJJ)" v-model="project.datumEnde"></td>
     </tr><tr>
     <td><label>Plätze (gesamt): </label></td>
     <td><input type="text" id="num" placeholder="Plätze" v-model="project.slotsGesamt"></td>
     </tr><tr>
     ...
     <td><input type="text" id="weblink" placeholder="Weblink" v-model="project.webLink"></td>
     </tr><tr>
     <td><label>Träger: </label></td>
     <td><input type="text" id="date" placeholder="Träger" v-model="project.traeger"></td>
     </tr><tr>
     <td></td><td><input v-if="this.id<0" type="submit" value="Eintragen"><input v-else type="submit" value="Bearbeiten"></td>
      </tr></table>
      </form>
    </main>
